...
\begin{table}[H]
	\begin{tabular}{|r|r|r|r|r|r|r|r|}
		\hline
		\rowcolor[HTML]{EFEFEF} 
		\multicolumn{1}{|c|}{\cellcolor[HTML]{EFEFEF}\begin{tabular}[c]{@{}c@{}}Current\\ $ I $ (A)\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}\begin{tabular}[c]{@{}c@{}}Magnetic Field\\ $ H $ (kG)\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$ \ln H $} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}\begin{tabular}[c]{@{}c@{}}Voltage\\ $ V_m $ (mV)\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}\begin{tabular}[c]{@{}c@{}}$ R_m $\\ ($ \Omega $)\end{tabular}} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$ \Delta R $} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$ \dfrac{\Delta R}{R_0} $} & \multicolumn{1}{c|}{\cellcolor[HTML]{EFEFEF}$ \ln \left( \dfrac{\Delta R}{R_0} \right) $} \\ \hline
